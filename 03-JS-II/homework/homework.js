...
function saludo(idioma) {
  ...
  // Tu código:
  const grettings = { aleman: "Guten Tag!", mandarin: "Ni Hao!", ingles: "Hello!" };
  return grettings[idioma] || "Hola!";
}
...
function esPrimo(numero) {
  ...
  let isPrime = true;
  for (let i = 2; i < numero / 2; i++) if (!(numero % i)) return (isPrime = false);
  return isPrime;
}
...
function tablaDelSeis() {
  ...
  //Escribe tu código aquí
  let res = [];
  for (let i = 0; i <= 10; i++) res.push(6 * i);
  return res;
}
